...
public class Customer implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2267111867694865521L;
	...
	public Customer(Long id, int version, String key, String email, long phone, String customerNumber, Date dateOfBirth,
			...
			boolean isEmailVerified, boolean isPhoneVerified, Long group, String username, String password) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Customer [id=" + id + ", version=" + version + ", key=" + key + ", email=" + email + ", phone=" + phone
				...
				+ ", group=" + group + ", username=" + username + ", password=" + password + ", getId()=" + getId()
				+ ", getVersion()=" + getVersion() + ", getKey()=" + getKey() + ", getEmail()=" + getEmail()
				+ ", getPhone()=" + getPhone() + ", getCustomerNumber()=" + getCustomerNumber() + ", getDateOfBirth()="
				+ getDateOfBirth() + ", getGender()=" + getGender() + ", getFirstName()=" + getFirstName()
				+ ", getLastName()=" + getLastName() + ", getMiddleName()=" + getMiddleName() + ", getSalutation()="
				+ getSalutation() + ", isEmailVerified()=" + isEmailVerified() + ", isPhoneVerified()="
				+ isPhoneVerified() + ", getUsername()=" + getUsername() + ", getPassword()=" + getPassword()
				+ ", getGroup()=" + getGroup() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
