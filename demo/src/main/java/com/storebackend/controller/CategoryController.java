 ...
 */
@RestController
@RequestMapping(value = CommonConstants.CategoryService_Path)
public class CategoryController {
	...
	@GetMapping(value = CommonConstants.CategoryService_Path_Find, produces = "application/json")
	public List<Category> find() {
		return categoryJpa.findAll();
	}

	@PostMapping(value = CommonConstants.CategoryService_Path_Create, produces = "application/json")
